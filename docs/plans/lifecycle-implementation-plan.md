...
**Status:** Milestone 0 remains accepted for substantive documentation baseline `7eaec6c`. Milestone 1 is In progress: its FIRST focused-test harness prerequisite is accepted at `2669cac5cd51bf8a20f30dd61258506c97fd096f` ([receipt](#milestone-1-first-focused-test-harness-acceptance-receipt)), and strict TOML persistence is accepted at `854a4165951cbdc8b812f7b28ccc6584b6636e2b` ([receipt](#milestone-1-strict-toml-persistence-acceptance-receipt)); full Milestone 1 is not accepted. Remaining native filesystem gates, anchored safety, transaction outcomes, locking, protected inventory, relocation fidelity, EXDEV handling, and caller migrations are pending. Milestones 2–7 remain planned. The user now authorizes the full remaining plan in prerequisite order, subject to its acceptance gates; limited authorizations in earlier receipts are historical, not current scope restrictions. This update records status/evidence only and implements no next slice.
...
| 1. Persistence/filesystem foundations | In progress; focused-test harness and strict TOML persistence accepted; remaining foundations and caller migrations pending | [Harness receipt](#milestone-1-first-focused-test-harness-acceptance-receipt); [strict persistence receipt](#milestone-1-strict-toml-persistence-acceptance-receipt); full M1 and Linux/native filesystem gates pending |
